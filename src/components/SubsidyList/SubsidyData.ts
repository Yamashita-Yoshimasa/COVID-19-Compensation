  ...
  Freelance: {
    ...
    subsidylist: [
      ...
      },
      {
        ...
        name: '小学校休業等対応支援金',
        summary:
          '令和2年2月27日から6月30日までの間に、小学校等の臨時休業に伴い、子供の世話を行うために、契約した仕事ができなくなった個人で仕事をする保護者が対象です。<br />＜給付額＞：4,100円/１日(定額)',
  ...
  Employer: {
    ...
    subsidylist: [
      ...
      },
      {
        ...
        name: '小学校休業等対応助成金',
        summary:
          '令和2年2月27日から6月30日までの間に、小学校等の臨時休業に伴い、子供の世話を行うことが必要となった労働者に対し、有給(賃金全額支給)の休暇(労働基準法上の年次有給休暇を除く)を取得させた事業主が対象です。<br />＜給付額＞：有給休暇を取得した対象労働者に支払った賃金相当額×10/10(上限8,330円)',
        source: [
